...
def normalize_intake(payload: PenIntakeRequest) -> PenNormalizedIntake:
    ...
    return PenNormalizedIntake(
        ...
        cardiovascular_conditions=_normalize_unique_text_list(payload.cardiovascular_conditions),
        ...
        which_treatment=_normalize_unique_text_list(payload.which_treatment),
